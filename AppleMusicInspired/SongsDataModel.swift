...
//    }
    ...
    static func songsCollection() -> [SongDetales] {
        return [
            SongDetales(image: UIImage(imageLiteralResourceName: "song1"), artist: "John Denver", name: "Take me home", category: CategoryName.gold),
            SongDetales(image: UIImage(imageLiteralResourceName: "song2"), artist: "*NSYNC", name: "I'll never stop", category: CategoryName.gold),
